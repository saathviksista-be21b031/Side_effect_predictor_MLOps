...
def predict_function(SE,df):# still have to figure out how to pass df data to the predict function call
    ...
    model,max_auc=training_function(SE,SE_drugs,all_drugs,CONFIG["training_data_path"])
